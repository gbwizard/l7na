...
read_reg INT  0x2100 0 "Inertia ratio"
read_reg INT  0x2106 0 "0x2106"
read_reg INT  0x2107 0 "0x2107"
read_reg INT  0x2108 0 "0x2108"
read_reg INT  0x2109 0 "0x2109"
...
read_reg INT 0x6072 0 "Maximum torque"
...
read_reg DINT 0x6083 0 "Profile acceleration"
read_reg DINT 0x6084 0 "Profile decceleration"
